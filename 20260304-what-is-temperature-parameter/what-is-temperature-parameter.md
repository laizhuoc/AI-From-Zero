...
# 什么是temperature参数？为什么调整"温度"能控制AI的创造力？

在使用大语言模型时，你可能经常听到"temperature"（温度）这个参数。它就像AI的"创造力调节器"，通过调整这个看似神秘的数字，我们就能控制AI输出是保守稳妥还是天马行空。那么，temperature到底是什么？它又是如何影响AI的创造力的呢？
